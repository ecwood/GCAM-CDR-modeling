...
│    │   │       │   │                            🟩 to DAC). 🟩
│    │   │       │   │
│    │   │       │   ├── A62.sector.csv 🟩 This file sets the input units, output units, and price units for DAC and 🟩
│    │   │       │   │                  🟩 CCS. It also sets the logit exponents for these technologies. 🟩
│    │   │       │   │
...
│    │   │   │
│    │   │   ├── zchunk_L262.dac.R 🟩 This script takes several CSV files as input as well as the output of 🟩
│    │   │   │                     🟩 zchunk_LA162.dac.R to generate several internally stored "files" (not 🟩
│    │   │   │                     🟩 readable by user) regarding global DAC deployment. 🟩
│    │   │   │
│    │   │   ├── zchunk_L262.dac_USA.R 🟩 This script uses two gcam-usa files and two other CSV files, along with 🟩
│    │   │   │                         🟩 several outputs from zchunk_LA262.dac.R to generate several USA specific 🟩
│    │   │   │                         🟩 internally stored "files" (not readable by user) of them. 🟩
│    │   │   │
│    │   │   └── zchunk_LA162.dac.R 🟩 This script uses the calibration file (energy/A62.calibration.csv) to 🟩
│    │   │                          🟩 to create an internally stored "file" (not readable by user) of it. 🟩
│    │   ├── README.md
│    │   ├── renv
│    │   ├── renv.lock
│    │   ├── solution
│    │   │   └── cal_broyden_config.xml 🟩 This file contains important information on how the model should be run. 🟩
│    │   │                              🟩 It is not generated by a CSV file. Instead, it comes in the GitHub 🟩
│    │   │                              🟩 package. Our setup script modifies the "max-model-calcs" paramater so 🟩
│    │   │                              🟩 that it is higher, which is necessary for our runs. You can also change 
│    │   │                              🟩 the solution tolerance here. 🟩
│    │   ├── tests
│    │   ├── vignettes
│    │   │   ├── driverdrake_vignette.Rmd 🟩 This is an R Markdown (documentation) file by GCAM that details how to 🟩
│    │   │   │                            🟩 use the R driver called drake to build the XML files. Our setup script 🟩
│    │   │   │                            🟩 modifies the Makefile so that this is the default, in addition to 🟩
│    │   │   │                            🟩 installing it. Using this driver greatly speeds up the XML build process 🟩
│    │   │   │                            🟩 because it only builds ones that have been changed. 🟩
│    │   │   │
│    │   │   └── usermod_vignette.Rmd 🟩 This is an R Markdown (documentation) file that details the GCAM endorsed 🟩
│    │   │                            🟩 method for making changes to the XML files. 🟩
│    │   │
│    │   └── xml 🟦 🟦
│    │   │   │
│    │   │   ├── dac_ssp1.xml 🟩 🟩
